...
class _DateTimeWidgetState extends State<DateTimeWidget> {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<WeatherModel?>(
      future: Weather().getWeather('San Juan del Río'),
            ...
            child: Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/images/3d.jpg'),
                  fit: BoxFit.cover,
                  ...
                  Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                    ...
                    /*Text(
                      ...
                      style: const TextStyle(
                        ...
                        fontWeight: FontWeight.bold, // Grosor de la fuente
                        letterSpacing: 0.5,
                        color: Color.fromARGB(255, 178, 188, 242), // Color del texto
                      ),
                    ),*/
                  ]),
                  const SizedBox(height: 5),
                  Text(
                    _currentDate.toUpperCase(),//FECHA
                    style: const TextStyle(
                  ...
                  Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                    Text(
                      ...
                      style: const TextStyle(
                        ...
                        fontFamily:
                            'Baskerville', // Fuente personalizada (opcional)
                      ),
                    ),
                    const SizedBox(width: 3),
                    Column(children: [
